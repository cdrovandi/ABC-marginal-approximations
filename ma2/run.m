...
% run SMC sampler
[part_vals_smc, part_sim_smc, part_s_smc, smc_sims, smc_epsilon_t, smc_p_acc_t] = smc_abc_rw_generic_continue(y,part_vals_smc,part_sim_smc(:,1:2),sim_func,dist_func,dist_func,smry_func,smry_func_pilot,prior_funcs,extra_args,N,epsilon_final,a,c,p_acc_min);
...
% run SMC sampler
[part_vals_smc, part_sim_smc, part_s_smc, smc_sims, smc_epsilon_t, smc_p_acc_t] = smc_abc_rw_generic_continue(y,part_vals_smc,part_sim_smc(:,3),sim_func,dist_func,dist_func,smry_func,smry_func_pilot,prior_funcs,extra_args,N,epsilon_final,a,c,p_acc_min);
