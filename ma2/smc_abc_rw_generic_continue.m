function [part_vals, part_sim, part_s, sims,dist_t,p_acc_t,dist_history,sims_history] = smc_abc_rw_generic_continue(y,part_vals,part_sim,sim_func,...
...
part_obs_pilot = smry_func_pilot(y,extra_args);
...
while (dist_max > dist_final)
    ...
    parfor i = (num_keep+1):N
        for r = 1:mcmc_trials
            ...
            part_sim_pilot_prop = smry_func_pilot(y_s,extra_args);
            dist_prop_pilot = dist_func_pilot(part_obs_pilot,part_sim_pilot_prop,extra_args);
            ...
            if (dist_prop <= dist_next && dist_prop_pilot <= extra_args.dist_pilot) 
